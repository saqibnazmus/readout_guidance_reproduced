...
###loading controlnet in which pseudo-labels for the control are computed by the  off-the-shed models and standardized into RGB images
...
def run_preset_generation( pipeline, prompts, latents, edits=[],
    # generation kwargs
    text_weight=7.5,rg_weight=2e-2,rg_ratio=[0.0, 1.0],num_recurrent_steps=1,negative_prompt="",log_freq=10,
    # scheduler kwargs
    eta=1.0,num_timesteps=100,zs=None,
    # rg kwargs
    idxs=None,points=None,latent_dim=None
):
